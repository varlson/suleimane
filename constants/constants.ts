...
export const me = {
  value: ` " Nasci numa cidadezinha do interior, distante da capital Bissau, durante a metade da década de 90, e tive minha infância nos anos 2000. Mesmo sendo essa uma anos 2000, os valores e costumes que permeavam minha cidade remontavam a tempos anteriores, época em que o respeito, a responsabilidade e o compromisso eram colocados acima de tudo. Esses valores moldaram minha personalidade desde cedo. Cresci com um profundo senso de responsabilidade, um compromisso e, principalmente, um respeito por tudo e por todos ao meu redor. São esses valores que carrego comigo ao longo da vida, lembrando-me constantemente da importância de honrar e preservar tais princípios em todas as minhas ações. "`,
